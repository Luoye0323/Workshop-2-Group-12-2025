...
# === Setup OpenAI ===
OPENAI_API_KEY = "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"  # Replace with your OpenAI API key
    ...
    for attempt in range(1, max_retries + 1):
        try:
            response = client.chat.completions.create(
                model="gpt-4o",  # OpenAI's vision model (gpt-4o, gpt-4o-mini, or gpt-4-turbo)
                messages=[
                    {
                        "role": "user",
                        "content": [
