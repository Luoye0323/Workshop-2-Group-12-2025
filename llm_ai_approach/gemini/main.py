...
# === 2. load & preprocess ===
image_path = "/Users/muhammadputraazam/Desktop/uni/S5/workshop2/Workshop-2-Group-12-2025/llm_ai_approach/gemini/MLK PMT 10108 - H-002.pdf"
...
# === 3. construct prompt ===
prompt = "Locate the Design Data and then extract the tabular data from this image and return JSON format {'headers': [...], 'rows': [...]} (no text outside table)."
contents = [
